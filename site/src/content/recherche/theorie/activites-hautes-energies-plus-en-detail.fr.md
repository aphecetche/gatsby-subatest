...
path: "recherche/theorie/activites-hautes-energies-plus-en-detail.fr.md"
joomlaid: 399
category: "theorie"
asides: ["theorie.+menu+"]
layout: "recherche"
...
*   *   **Phénoménologie des processus durs** -- Dans le cadre de la PQCD, on cherche à confronter les calculs théoriques aux données expérimentales pour les processus _durs_ (impliquant une échelle \\( Q \\gg 1\\,\\rm{GeV}\\)). Ceci permet de tester plus avant la PQCD, notamment dans le cadre des théorèmes de factorisation. Diverses thématiques sont abordées:
        ...
        *   [Quarks lourds et quarkonia dans le QGP](/recherche/theoriehe/quarks-lourds-et-quarkonia-dans-un-plasma.fr)
        *   [Propagation des partons dans la matière nucléaire](/recherche/theoriehe/propagation-des-partons-dans-la-matiere-nucleaire.fr)
...
*   *   **Etude globale d'événements** -- Nous étudions différents phénomènes à l'interface entre le langage hadronique et le langage partonique:[](fr/recherche/theorie-haute-energie/theoriehe-nouvelles/205-werner1)
        *   [Formation, évolution et hadronisation du plasma de quarks et de gluons](/recherche/theoriehe/werner1.fr)
        *   [Gerbes de rayons cosmiques](/recherche/theoriehe/gerbes-de-rayons-cosmiques.fr)
...
*   *   **Autres thématiques: théorie pure, valorisation et applications**:
        *   [Théorie des champs](/recherche/theoriehe/theorie-quantique-des-champs.fr)
        *   [Sens électrique des poissons](/recherche/theoriehe/electrolocation.fr)
        *   Applications de QM
